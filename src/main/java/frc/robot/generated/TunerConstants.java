...
public class TunerConstants {
    ...
    private static final double kFrontLeftEncoderOffset = -0.08642578125;
    private static final boolean kFrontLeftSteerInvert = true;

    private static final double kFrontLeftXPosInches = 12.4375;
    private static final double kFrontLeftYPosInches = 12.4375;
    ...
    private static final double kFrontRightXPosInches = 12.4375;
    private static final double kFrontRightYPosInches = -12.4375;

    // Back Left
    private static final int kBackLeftDriveMotorId = 12;
    private static final int kBackLeftSteerMotorId = 9;
    private static final int kBackLeftEncoderId = 3;
    private static final double kBackLeftEncoderOffset = 0.302001953125;
    private static final boolean kBackLeftSteerInvert = true;

    private static final double kBackLeftXPosInches = -12.4375;
    private static final double kBackLeftYPosInches = 12.4375;

    // Back Right
    private static final int kBackRightDriveMotorId = 5;
    private static final int kBackRightSteerMotorId = 11;
    private static final int kBackRightEncoderId = 2;
    private static final double kBackRightEncoderOffset = -0.37890625;
    private static final boolean kBackRightSteerInvert = true;

    private static final double kBackRightXPosInches = -12.4375;
    private static final double kBackRightYPosInches = -12.4375;
